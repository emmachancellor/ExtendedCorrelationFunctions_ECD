...
if __name__ == '__main__':
    ...
    markers = ['PD-L1_status', 'CD45_status']
    ...
    save_ks_results_path = '/michorlab/ecdyer/multiplex_spatial/tcm_results/pdl1_cd45/'
    save_tcm_path = '/michorlab/ecdyer/multiplex_spatial/tcm_results/pdl1_cd45/'
    save_csr_tcm_path = '/michorlab/ecdyer/multiplex_spatial/tcm_results/pdl1_cd45/'

    with open('tcm_output_pdl1_cd45.txt', 'w') as f:
